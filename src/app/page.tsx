...
const pillars = [
  {
    ...
    body: "Short lessons, a glossary, quizzes, diagrams, rivalries and famous players. Mini Games sit next door if you want a score — rules for beginners, fun trivia if you already stay up for the late kick-off. Built for UK beginners who keep hearing yards, downs and flags and want them explained without the jargon first.",
    cta: "Open Learn",
  },
  {
    href: "/community",
