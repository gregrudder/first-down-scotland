...
export const miniGamesIntro = {
  ...
  title: "Mini Games",
  lead:
    "Short, tap-the-answer games. No downloads, no accounts, no heavy graphics. Some help you learn the sport. The fun quizzes are just for fun: famous moments, silly names, late-night survival. Your score stays on this page until you have another go.",
};
