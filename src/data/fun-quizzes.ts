...
/**
 * Entertainment quizzes for fans who already like the NFL.
...
export const funQuizzes: MiniGame[] = [
  ...
  {
    slug: "qb-or-appliance",
    title: "Quarterback or kitchen appliance?",
    summary:
      "A name walks in. Is it a bloke who throws footballs, or something you would plug in next to the kettle? Tasteful. Slightly unhinged.",
    minutes: 3,
    kind: "fun",
    learnHref: "/mini-games",
    learnLabel: "More quizzes",
    questions: [
      {
        id: "baker",
        prompt: "Baker Mayfield: quarterback, or a mid-range bread brand?",
        options: ["Quarterback", "Bread brand / bakery chain"],
        correctIndex: 0,
        explain:
          "Quarterback. He has started for Cleveland, Carolina, and Tampa Bay, and he really is called Baker. The rolls are sold under other names.",
      },
      {
        id: "air-fryer",
        prompt: "Air fryer: quarterback, or kitchen appliance?",
        options: ["Quarterback", "Kitchen appliance"],
        correctIndex: 1,
        explain:
          "Appliance. It lives on the counter, judges your chips, and has never taken a snap. If a roster listed one, we would have heard.",
      },
      {
        id: "mac-jones",
        prompt: "Which of these has actually started an NFL game at quarterback?",
        options: ["Kenwood Chef", "Dualit toaster", "Mac Jones", "Ninja blender"],
        correctIndex: 2,
        explain:
          "Mac Jones. Patriots first-rounder in 2021, and he has started NFL games. The Kenwood Chef remains undefeated in the baking category.",
      },
      {
        id: "instant-pot",
        prompt: "Instant Pot: franchise quarterback, or a pressure cooker with a marketing department?",
        options: ["Franchise quarterback", "Pressure cooker with a marketing department"],
        correctIndex: 1,
        explain:
          "It is a pot. It makes stew. It does not audible to a sluggo. Do not put one under centre, even in pre-season.",
      },
      {
        id: "bo-nix",
        prompt: "Bo Nix: Broncos quarterback, or a spray you use on hob rings?",
        options: ["Broncos quarterback", "Hob-ring spray"],
        correctIndex: 0,
        explain:
          "Quarterback. Denver drafted him in 2024. The name sounds like it should live under the sink. It does not. That is the joke, and also the answer.",
      },
      {
        id: "foreman",
        prompt: "George Foreman Grill: retired heavyweight who also played quarterback, or just a grill?",
        options: [
          "He was a quarterback; the grill is a side hustle",
          "Just a grill (and a boxer). Not a quarterback",
        ],
        correctIndex: 1,
        explain:
          "Boxer, preacher, grill salesman. Not an NFL quarterback. If you ticked the first one because “George” felt sportsy, the kitchen says hello.",
      },
      {
        id: "purdy",
        prompt: "Brock Purdy: 49ers quarterback, or a citrus-scented stain remover?",
        options: ["49ers quarterback", "Citrus-scented stain remover"],
        correctIndex: 0,
        explain:
          "Quarterback. Last pick of the 2022 draft, then a starter in San Francisco. “Purdy” would be a decent name for a spray. The league already claimed it.",
      },
      {
        id: "which-qb",
        prompt: "Which of these is the quarterback?",
        options: ["Salad spinner", "C.J. Stroud", "Rice cooker", "Sandwich press"],
        correctIndex: 1,
        explain:
          "C.J. Stroud, Houston Texans. The rice cooker is closer to Jerry Rice than to a snap count, and that is still not close enough.",
      },
    ],
  },
  {
