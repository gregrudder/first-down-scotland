    ...
    <div className="mt-6 rounded-2xl border border-line bg-navy-2 p-4 sm:flex sm:items-center sm:justify-between sm:gap-4">
      <div className="min-w-0">
        ...
        <p className="mt-1 max-w-xl text-sm leading-6 text-cream-dim">
          ...
          Highlight links stay behind a branded tile so YouTube’s title and
          thumbnail do not appear until you confirm. Teams, UK kick-off and TV
          stay visible. Saved in this browser.
        </p>
      </div>
      <button
        ref={buttonRef}
