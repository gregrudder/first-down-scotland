...
- **`/mini-games`** : separate browser games — beginner quizzes (rules, Who am I?, down-and-distance, rivalry match-up) plus nine fun fan quizzes (Super Bowls, catches, jersey numbers, late-night survival, and the rest). Not part of the lesson path.
